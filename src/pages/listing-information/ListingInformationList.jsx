import ListingInformationTable from '@/components/listing-information-list';
import ArrowLeftSvg from '@/components/svgs/ArrowLeftSvg';
import PlusSvg from '@/components/svgs/PlusSvg';
import { useDeleteListingInformation } from '@/hooks/new-listing-information';
import { cn } from '@/lib/utils';
import { Trash2Icon } from 'lucide-react';
import { Link, useLocation } from 'react-router-dom';

const ListingInformationList = () => {
  //   const tabs = [
    ...
    <>
      <div className="flex items-center gap-4 justify-between">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            to="/my-systems/new-listing/new-listing-information-form"
          ...
          >
            <p className="sm:block hidden">New Listing Information</p>
...
export default ListingInformationList;
