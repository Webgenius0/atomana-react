import MyListingExpenseTable from '@/components/my-listing-table/MyListingExpenseTable';
...
const MyListingExpense2 = () => {
  const tabs = [
    { label: 'Forms', path: '/my-systems/finances/my-listing2' },
...
export default MyListingExpense2;
