...
const HoaDocument = () => {
  return (
    <div className="pt-6 md:pt-8 lg:pt-12 pb-3">
      ...
      <div className="mt-5 md:mt-7 lg:mt-[34px]">
        <h2 className="section-title">HOA Contact Information</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 xl:gap-[50px] mt-4">
          {/* Address */}
          ...
          <div className="space-y-[2px] border-b border-secondPrimary py-2 md:py-4">
            ...
            <p className="text-sm font-normal leading-5 text-[#ffffffcc]">
              789 Maple Grove Lane, Suite 100, San Francisco, CA 94117
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-[25px]">
        ...
        <div className=" max-w-lg grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1  gap-2 md:gap-5 md:mt-4">
          <div className="space-y-[2px] border-b border-secondPrimary py-2 md:py-4">
