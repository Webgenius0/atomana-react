  ...
  return (
    <div className="my-container pt-12 pb-3">
      <div className="flex items-center justify-between">
        ...
        >
          Add team member
          <span className="w-8 h-8 rounded-full flex items-center justify-center border border-[#024040] bg-gradient-to-r from-black via-black to-[#024040] shadow-[0_0_0_1px_black]">
            <PlusSvg />
          </span>
        </Link>
      </div>
