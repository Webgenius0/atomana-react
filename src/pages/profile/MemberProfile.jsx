...
const MemberProfile = () => {
  return (
    <div className="my-container">
      <div className="space-y-0 md:space-y-[25px] py-[25px]">
        <div className="flex flex-col items-center gap-2 mb-0 md:mb-6">
          <img
            src={profileAvatar}
          ...
          <p className="text-light text-center text-base md:text-lg lg:text-xl font-medium leading-[21px] tracking-[-0.2px]">
            Jamal Ahmed
          </p>
        ...
        <div className="py-6 md:py-8 lg:pt-12 pb-3">
