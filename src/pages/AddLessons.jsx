...
function AddLessons() {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className="my-container flex flex-col justify-between h-[80vh]">
                <div>
                    ...
                    <div className="max-w-[684px] w-full mx-auto">
                        <div className='flex flex-col gap-8'>
                            <input type="text" placeholder='title' {...register("title")} className='text-white/50 font-Inria text-xl italic font-bold leading-3xl tracking-[-0.2px] capitalize outline-none bg-[#151515] pl-12' />
                            <textarea placeholder='| description' {...register("description")} className='text-white placeholder:text-white/50 placeholder:italic py-2 font-Inria text-base font-normal leading-xl  tracking-[-0.2px] capitalize outline-none bg-[#151515] w-full min-h-[40px] pl-12' rows="1" />
                            <div className='flex items-center gap-4 cursor-pointer'>
                                ...
                                <div className={`flex items-center gap-4 ${showGallery ? "block" : "hidden"}`}>
                                    ...
                                    <span className='cursor-pointer'>
                                        ...
                                        <input type="file" className='hidden text-white' id='image-upload' accept='image/*' onChange={(e) => handleImageUploader(e)} />
                                    </span>
                                    <span className='cursor-pointer'>
                                        ...
                                        <input type="file" className='hidden text-white' id='video-upload' accept='image/*' onChange={(e) => handleVideoUploader(e)} />
                                    </span>
                                </div>
                            </div>
                ...
                <div className="flex items-center justify-between sm:flex-row flex-col sm:space-y-0 space-y-4">
                    ...
                    <input
                        ...
                        value="Add"
                    />
                    <button onClick={handleResetButton} className="request-btn text-light bg-[#151515] px-6 py-3 rounded-lg hover:opacity-80 duration-300">
                        Cancel
                    </button>
                </div>
            </form>
