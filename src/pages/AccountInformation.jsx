    ...
    <div className="my-container pt-12 pb-3">
      ...
      <div className="mt-[25px]">
        <div className="space-y-[2px] border-b border-secondPrimary py-4">
          ...
          <p className="text-sm font-medium leading-5 text-light">Elena Laol</p>
        </div>
        <div className="space-y-[2px] border-b border-secondPrimary py-4">
        ...
        <div className="space-y-[2px] border-b border-secondPrimary py-4">
          ...
          <p className="text-sm font-medium leading-5 text-light">329792802</p>
        </div>
        <div className="space-y-[2px] border-b border-secondPrimary py-4">
          <p className="font-bold leading-5 text-sm text-[#ffffffcc]">
            ECAR ID
        ...
        <div className="space-y-[2px] border-b border-secondPrimary py-4">
          <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Status</p>
