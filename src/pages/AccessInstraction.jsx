                ...
                <div className="pt-6 md:pt-8 lg:pt-12 pb-3">
                    <div className="mt-[25px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-12 md:mt-4">
                            ...
                            {/* Property Type */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Property Type</p>
                                <p className="text-sm font-normal leading-5 text-[#009696]">Apartment</p>
                            </div>

                            {/* Price */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Price</p>
                                <p className="text-sm font-normal leading-5 text-[#009696]">$1,200,000</p>
                            </div>

                            {/* Size */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Size</p>
                                <p className="text-sm font-normal leading-5 text-[#009696]">1,500 sq ft</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-[25px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 md:gap-12 md:mt-4">
                            ...
                            {/* Property Type */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Lockbox Location</p>
                                <p className="text-sm font-normal leading-5 text-[#ffffffcc]">Lockbox is located on the front door handle.</p>
                            </div>

                            {/* Price */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Key Pickup Instructions (if applicable):</p>
                                <p className="text-sm font-normal leading-5 text-[#ffffffcc]">Keys can also be picked up from the listing office at 456 Realty Lane, Suite 101, between 9 AM - 5 PM.</p>
                            </div>
                    ...
                    <div className="mt-[25px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 md:gap-12 md:mt-4">
                            ...
                            {/* Property Type */}
                            <div className="space-y-[2px] border-b border-secondPrimary py-4">
                                <p className="font-bold leading-5 text-sm text-[#ffffffcc]">Gate Access Location</p>
                                <p className="text-sm font-normal leading-5 text-[#ffffffcc]">Main gate entrance on Oakwood Drive. Use the keypad located on the left side of the gate.</p>
                            </div>
