...
const SignUp = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (response.success) {
          ...
          setErrorMessage(response.message || "An error occurred during signup.");
        }
        ...
        <div className="min-h-screen flex justify-center bg-[#151515] text-[#FFFFFF]">
            <div className="max-w-screen-xl w-full flex flex-col mx-auto flex-1 gap-[2rem] mb-4">
                ...
                <div className="max-w-[440px] w-full p-5 sm:p-0 mx-auto">
                    <div>
                        <strong className='font-Inria text-[18px] sm:text-[20px] italic font-bold leading-[24px] tracking-[-0.2px] capitalize'>Simplify. Organize. Succeed.</strong>
                        <p className='font-Inria text-[18px] sm:text-[20px] font-bold leading-[24px] tracking-[-0.2px] capitalize text-white/50 mt-[10px]'>Sign up and Create your MyOps account</p>
                    </div>
                    <div className="w-full mt-8 md:mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full">
                            <form className="w-full flex flex-col gap-[20px] mx-auto" onSubmit={handleSubmit(onSubmit)}>
