    ...
    <>
      <div className="pt-6 md:pt-4 lg:pt-4 pb-3">
        ...
        <div className="mt-5 md:mt-8 lg:mt-[20px]">
          ...
          <p className="font-bold leading-5 text-sm text-[#ffffffcc]">
            Bright Home Inspections has been serving the real estate industry
            for over 15 years, providing thorough, professional, and reliable
            home inspections across the Bay Area. Known for their detailed
            reports and quick turnaround times, Bright Home Inspections
            specializes in pre-purchase, pre-listing, and new construction
            inspections. Their team of certified inspectors ensures every
            property is evaluated with precision, helping agents and clients
        ...
        <div className="mt-[25px]">
          ...
          <div className="space-y-[2px]  py-4">
            <ul className="list-disc list-inside text-sm font-normal leading-5 text-[#ffffffcc]  ">
              ...
              <li className="indent-3">
                Services include foundation, roofing, HVAC, plumbing, electrical
                systems, and more.
              </li>
              <li className="indent-3">
        ...
        <div className="mt-5 md:mt-8 lg:mt-[30px]">
          <div className="flex justify-between items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <input
                    class="request-btn approve cursor-pointer"
                    type="submit"
                    value="Add a Review"
                  />
                </div>
          ...
          <div className="space-y-[2px] border-b border-secondPrimary py-4">
            <div>
              ...
              <h2 className="text-white font-inter text-[14px] font-normal leading-[20px]">
                Quick turnaround for my client last week. Inspector John was
          ...
          <div className="space-y-[2px] border-b border-secondPrimary py-4">
            <div>
              ...
              <h2 className="text-white font-inter text-[14px] font-normal leading-[20px]">
                Bright Home Inspections exceeded my expectations! The inspector
                arrived on time, was incredibly thorough, and provided a
                detailed report with photos by the end of the day. My clients
                felt confident moving forward with their purchase. Highly
          ...
          <div className="space-y-[2px] border-b border-secondPrimary py-4">
            <div>
              ...
              <h2 className="text-white font-inter text-[14px] font-normal leading-[20px]">
                Very professional and easy to work with. The team was responsive
                and flexible when we needed a last-minute inspection. The report
                was clear and easy to understand, although it arrived a little
                later than expected. Overall, great experience!
              </h2>
            </div>
          </div>
        </div>
