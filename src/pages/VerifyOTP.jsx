        ...
        <div className="min-h-screen flex justify-center bg-[#151515] text-[#FFFFFF]">
            <div className="max-w-screen-xl w-full flex flex-col mx-auto flex-1 gap-[2rem]">
                <div className="max-w-[440px] w-full p-5 sm:p-0 mx-auto mt-20">
                    ...
                    <form className="w-full mt-8 md:mt-12 flex flex-col gap-[8px] sm:gap-3">
                        <h2 className='text-base sm:text-lg'>Code</h2>
                        <div className="sm:flex grid grid-cols-6 gap-[6px] sm:gap-3">
                            <input className='border-2 border-white rounded-lg sm:rounded-xl text-white w-12 sm:w-14 h-12 sm:h-14 bg-[#151515] text-[20px] sm:text-[28px] text-center' type="text" />
                            <input className='border-2 border-white rounded-lg sm:rounded-xl text-white w-12 sm:w-14 h-12 sm:h-14 bg-[#151515] text-[20px] sm:text-[28px] text-center' type="text" />
                            <input className='border-2 border-white rounded-lg sm:rounded-xl text-white w-12 sm:w-14 h-12 sm:h-14 bg-[#151515] text-[20px] sm:text-[28px] text-center' type="text" />
                            <input className='border-2 border-white rounded-lg sm:rounded-xl text-white w-12 sm:w-14 h-12 sm:h-14 bg-[#151515] text-[20px] sm:text-[28px] text-center' type="text" />
                            <input className='border-2 border-white rounded-lg sm:rounded-xl text-white w-12 sm:w-14 h-12 sm:h-14 bg-[#151515] text-[20px] sm:text-[28px] text-center' type="text" />
                        ...
                        <div className='flex flex-col gap-0 sm:gap-1'>
                            <p className='font-medium text-sm sm:text-base'>The Code Expire in <span className='text-[rgba(0,150,150,1)] font-bold'>60</span> Second</p>
                            <p className='underline decoration-[rgba(0,150,150,1)] text-[rgba(0,150,150,1)] font-medium text-sm sm:text-base cursor-pointer'>Resend Code</p>
                        </div>
                    </form>
                </div>
            </div>
