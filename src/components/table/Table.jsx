        ...
        <tbody>
          {tableData.map((row, index) => (
            <tr key={index} className="">
              ...
              <td className="border border-[#5E5E5E] py-2 px-2.5 font-Roboto text-[11px] text-light tracking-[0.25px] font-normal text-center min-w-[73px]">
                {row.date}
              </td>
              ...
              <td
                className={`border border-[#5E5E5E] py-2 px-2.5 font-Roboto text-[11px] tracking-[0.25px] font-normal min-w-[135px] ${
                  row?.category === "Commission Income"
                    ? "bg-[#80CBC3] text-dark"
                    : row?.category === "Cost of Sales"
                    ? "bg-[#9AE4A7] text-dark"
                    : row?.category === "Referral Fee"
                    ? "bg-[#F286FE] text-dark"
                    : row?.category === "Operating Expenses"
                    ? "bg-[#80CBC3] text-dark"
                    : row?.category === "Gross Profit"
                    ? "bg-[#F286FE] text-dark"
                    : row?.category === "Net Income"
                    ? "bg-[#86B2FE] text-dark"
                    : "text-light"
                }`}
              >
              ...
              <td className="border border-[#5E5E5E] py-2 px-2.5 font-Roboto text-[11px] text-light tracking-[0.25px] font-normal min-w-[75px]">
                {row.subcategory}
              </td>
              <td className="border border-[#5E5E5E] py-2 px-2.5 font-Roboto text-[11px] text-light tracking-[0.25px] font-normal min-w-[200px]">
                {row.description}
              </td>
              ...
              <td className="border border-[#5E5E5E] py-2 px-2.5 font-Roboto text-[11px] text-[#009696] tracking-[0.25px] font-normal text-center min-w-[110px]">
                <div className="flex items-center gap-1">
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_2401_11593)">
                      <path
          ...
          <tr>
            ...
            <td className="border border-[#5E5E5E] p-2">
              ...
              >
                ...
                <option value="comission" className="bg-dark">
                  Commission Income
                </option>
                <option value="cof" className="bg-dark">
                  Cost of Sales
                </option>
                <option value="referral" className="bg-dark">
                  Referral Fee
                </option>
                <option value="operating-expense" className="bg-dark">
                  Operating Expenses
                </option>
                <option value="gp" className="bg-dark">
                  Gross Profit
                </option>
                <option value="net" className="bg-dark">
                  Net Income
                </option>
              </select>
            </td>
            <td className="border border-[#5E5E5E] p-2">
              ...
              >
                ...
                <option value="option2" className="bg-dark">
                  Option 2
                </option>
              </select>
            </td>
            ...
            <td className="border border-[#5E5E5E] p-2">
              <input
                type="number"
                className="w-full border bg-transparent p-2 text-[11px] text-light tracking-[0.25px] rounded appearance-none"
            ...
            <td className="border border-[#5E5E5E] p-2">
              <select
                className="py-2 px-2.5 font-Roboto text-[11px] text-light border border-light bg-transparent tracking-[0.25px] rounded cursor-pointer"
                value={newRow.vendorPayee}
                onChange={(e) => handleInputChange(e, "vendorPayee")}
              >
                <option value="" className="bg-dark">
                  Vendor / Payee
                </option>
            ...
            <td className="border border-[#5E5E5E] p-2">
              <label className="flex items-center gap-1 py-2 px-2.5 font-Roboto text-[11px] text-light border border-light bg-transparent tracking-[0.25px] rounded cursor-pointer">
                ...
                <span>{newRow?.receipt || "Add Receipt"}</span>
              </label>
            </td>
            <td className="border border-[#5E5E5E] p-2">
              <input
                type="text"
                className="w-full py-2 px-2.5 font-Roboto text-[11px] text-light border border-light bg-transparent tracking-[0.25px] rounded cursor-pointer"
            ...
            <td className="border border-[#5E5E5E] p-2">
              <select
                ...
                value={newRow.reimbursable}
                onChange={(e) => handleInputChange(e, "reimbursable")}
              >
                <option value="" className="bg-dark">
                  Reimbursable
                </option>
                <option value="yes" className="bg-dark">
                  Yes
                </option>
                <option value="no" className="bg-dark">
                  No
                </option>
              </select>
            </td>
            <td className="border border-[#5E5E5E] p-2">
              <input
                ...
                value={newRow.listing}
                onChange={(e) => handleInputChange(e, "listing")}
              />
            </td>
            <td className="border border-[#5E5E5E] p-2">
              <input
