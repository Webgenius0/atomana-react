...
export const dummyData = [
  {
    date: '2025-03-01',
    expense_category_id: 'Food & Dining',
    expense_sub_category_id: 'Groceries',
    description: 'Bought groceries from Walmart',
    amount: 150.75,
    payment_method_id: 'Credit Card',
    vendor_id: 'Walmart',
    recept: 'receipt_001.jpg',
    owner: 'John Doe',
    reimbursable: true,
    listing: 'Personal',
  ...
  {
    date: '2025-03-02',
    expense_category_id: 'Transport',
    expense_sub_category_id: 'Fuel',
    description: 'Filled gas tank',
    amount: 60.0,
    payment_method_id: 'Debit Card',
    vendor_id: 'Shell Gas Station',
    recept: 'receipt_002.jpg',
    owner: 'Jane Smith',
    reimbursable: false,
    listing: 'Work',
    note: 'Office commute fuel',
  },
  {
    date: '2025-03-03',
    expense_category_id: 'Utilities',
    expense_sub_category_id: 'Electricity',
    description: 'Monthly electricity bill',
    amount: 90.3,
    payment_method_id: 'Bank Transfer',
    vendor_id: 'City Electric Co.',
    recept: 'receipt_003.jpg',
    owner: 'John Doe',
    reimbursable: false,
    listing: 'Personal',
    note: 'March electricity bill',
  },
  {
    date: '2025-03-04',
    expense_category_id: 'Entertainment',
    expense_sub_category_id: 'Streaming Service',
    description: 'Netflix subscription renewal',
    amount: 15.99,
    payment_method_id: 'PayPal',
    vendor_id: 'Netflix',
    recept: 'receipt_004.jpg',
    owner: 'Jane Smith',
    reimbursable: false,
    listing: 'Personal',
  ...
  {
    date: '2025-03-05',
    expense_category_id: 'Health',
    expense_sub_category_id: 'Pharmacy',
    description: 'Bought prescription medicine',
    amount: 45.5,
    payment_method_id: 'Cash',
    vendor_id: 'CVS Pharmacy',
    recept: 'receipt_005.jpg',
    owner: 'John Doe',
    reimbursable: true,
    listing: 'Personal',
    note: 'Doctor prescribed medication',
  },
  {
    date: '2025-03-06',
    expense_category_id: 'Travel',
    expense_sub_category_id: 'Hotel',
    description: 'Hotel stay for business trip',
    amount: 250.0,
    payment_method_id: 'Company Card',
    vendor_id: 'Hilton Hotels',
    recept: 'receipt_006.jpg',
    owner: 'Jane Smith',
    reimbursable: true,
    listing: 'Work',
    note: 'Client meeting in NYC',
  },
];
